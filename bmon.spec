...
cp %{_builddir}/bmon-%{version}/LICENSE.BSD %{buildroot}/usr/share/package-licenses/bmon/d0f83c8198fdd5464d2373015b7b64ce7cae607e || :
cp %{_builddir}/bmon-%{version}/LICENSE.MIT %{buildroot}/usr/share/package-licenses/bmon/8570a5c766d8b7eda6fa171a7f6674e335b50c5e || :
%make_install
